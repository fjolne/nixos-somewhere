...
# This function is taken from https://github.com/elitak/nixos-infect
# It is modified to output config to stdout instead of writing it to the file.
# It is only needed in case the target machine network is configured in a custom way (not DHCP or cloud-init).
makeNetworkingConf() {
